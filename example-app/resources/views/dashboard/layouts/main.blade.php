        ...
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th scope="col">Id_Cafe</th>
              <th scope="col">Id_Jastip</th>
              <th scope="col">Tanggal</th>
              <th scope="col">Total Belanja</th>
              <th scope="col">Aksi</th>
            </tr>
          </thead>
          @foreach ($restok as $res)
              
          
          <tbody>
              <td>{{ $restok->id }}</td>
              <td>{{ $restok->nomor_nota }}</td>
              <td>{{ $restok->id_cafe}}</td>
              <td>{{ $restok->id_jastip }}</td>
              <td>{{ $restok->tanggal }}</td>
              <td>{{ $restok->total_belanja }}</td>
              <td> <a href="#">Edit</a> - <a href="#">Hapus</a></td>
